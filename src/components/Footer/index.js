  ...
  return (
    <footer className="rodape">
      <div className="rodape__logo">
        ...
        <p>
          Av. Alberto Carazzai, 1640 - Centro, Cornélio Procópio - PR, 86300-000
        </p>
      </div>
      ...
      <div className="rodape__redes-sociais">
        <div>
          <Link
            className="rede-social--icon"
            to="https://www.instagram.com/utfprcampuscornelio/"
          >
            <FaInstagram />
          </Link>
          <Link className="rede-social--icon" to="https://twitter.com/UtfprP">
            <FaTwitter />
          </Link>
          <Link
            className="rede-social--icon"
            to="https://www.facebook.com/utfprcp"
          >
            <FaFacebookF />
          </Link>
        </div>
